...
public class PayChannelServiceClient {
    ...
    @HystrixCommand(fallbackMethod = "selectByMchIdAndPayTypeFallback")
    public String selectByMchIdAndPayType(String jsonParam){
        return restTemplate.getForEntity("http://xxpay-service/pay_channel/select_by_mchid_paytype?jsonParam=" + MyBase64.encode(jsonParam.getBytes()), String.class).getBody();
    }

    public String selectByMchIdAndPayTypeFallback(String jsonParam) {
        return "error";
    }
}