 ...
 */
@RestController
public class Notify4O9n2Controller extends Notify4BasePay {

    private static final MyLog _log = MyLog.getLog(Notify4O9n2Controller.class);
     ...
     * @throws IOException
     */
    @RequestMapping(value = "/pay/o9n2PayNotifyRes.htm")
    public void aliPayNotifyRes(HttpServletRequest request, HttpServletResponse response) throws IllegalAccessException {
        ...
        if (result != null) {
            _log.info("o9n2 notify response: {}", result);
    ...
    public String doPayRes(HttpServletRequest request, HttpServletResponse response) throws IllegalAccessException  {
        String logPrefix = "【o9n2支付回调通知】";
        _log.info("====== 开始接收o9n2支付回调通知 ======");
        //获取支付宝POST过来反馈信息
