 ...
 */
@RestController
public class Notify4MZWYQController extends Notify4BasePay {

    private static final MyLog _log = MyLog.getLog(Notify4MZWYQController.class);
    ...
    private static final String logPrefix = "【支付宝H5支付回调通知】";
     ...
     * @throws IOException
     */
    @RequestMapping(value = "/pay/mzwyqPayNotifyRes.htm")
