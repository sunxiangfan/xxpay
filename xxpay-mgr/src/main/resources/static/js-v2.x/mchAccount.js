layui.define(['form', 'table', 'myUpload', 'myList', 'laytpl', 'layer'], function (exports) {
    ...
    var mod_name = 'mchAccount',
        Model = function () {
            var config = {
                title: '商户账户'
                , listUrl: '/mch_account/list'
                , viewUrl: '/mch_account/view.html'
                , editUrl: '/mch_account/edit.html'
                , saveUrl: '/mch_account/save'
                , lockAmountUrl: '/mch_account/lock_amount.html'
                , unlockAmountUrl: '/mch_account/unlock_amount.html'
                , saveLockAmountUrl: '/mch_account/lock_amount'
                , saveUnlockAmountUrl: '/mch_account/unlock_amount'
                , adjustIncreaseAmountUrl: '/mch_account/adjust_increase_amount.html'
                , saveAdjustIncreaseAmountUrl: '/mch_account/adjust_increase_amount'
                , adjustDecreaseAmountUrl: '/mch_account/adjust_decrease_amount.html'
                , saveAdjustDecreaseAmountUrl: '/mch_account/adjust_decrease_amount'
                , keyName: 'id'
                , cols: [[
                    {type: 'radio'}
                    , {title: '操作', toolbar: '#barCtrl', width: 170}
                    , {field: 'id', title: '商户号'}
