...
import org.xxpay.mgr.service.CashApplyChannelService;
...
public class ChannelThree10000 {
    private static  final  String MCH_ID="";
    private static final String KEY = "";
    private final static MyLog _log = MyLog.getLog(ChannelThree10000.class);
    public JSONObject applyThree10000(MchWithdrawApply apply, long actualApplyAmount) throws UnsupportedEncodingException, IllegalAccessException, IOException {
        _log.info("===========three10000 代付接口开始处理============");
