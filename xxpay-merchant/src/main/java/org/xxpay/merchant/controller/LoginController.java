...
public class LoginController {
    ...
    public String save(@RequestParam String params) {
        ...
        try {
            ...
            MchInfo mchInfo = mchInfoService.login(loginAccount, password);
            Assert.notNull(mchInfo, "商户信息不存在！");
            Assert.isTrue(MchState.ENABLE.getCode().equals(mchInfo.getState()), "商户已停用！");
            SessionUtil.LoginInfo loginInfo = SessionUtil.LoginInfo.buildByMchInfo( mchInfo);
