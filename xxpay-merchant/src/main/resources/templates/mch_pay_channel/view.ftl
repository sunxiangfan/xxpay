<div style="margin: 15px;">
	<form class="layui-form">
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-block">
				<#if mchInfo?exists>
					...
					<input type="text" name="name" disabled="disabled" lay-verify="required" placeholder="请输入商户" autocomplete="off"
			...
			<div class="layui-input-block">
				<#if  payChannel?exists>
					<input type="text" name="passagewayName" disabled="disabled" lay-verify="required"  autocomplete="off"
						   class="layui-input" value="${payChannel.name} ( ${payChannel.code} )">
				</#if>
			</div>
		</div>
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-block">
				<input type="number" name="platformDeductionRate" disabled="disabled" autocomplete="off" class="layui-input" value="${item.platformDeductionRate?if_exists }">
			</div>
		</div>-->
		<div class="layui-form-item">
